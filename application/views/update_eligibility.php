        ...
        for ($x=2014; $x>=1940; $x--)
        {
            ...
            echo "<table>";
                echo form_open('update/eligibility');
                    ...
                    echo "<tr><td>Exam Name</td><td>".form_input('examName', $page_view_content['exam_name'])."</td></tr>";
                    ...
                    echo "<tr><td>Exam Place</td><td>".form_input('examPlace', $page_view_content['exam_place'])."</td></tr>";
                    echo "<tr><td>Rating</td><td>".form_input('rating', $page_view_content['rating'])."</td></tr>";
