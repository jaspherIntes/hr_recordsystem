<div class="body">
    ...
    {
    ?>
        <?php echo '<a href="'.base_url().'index.php/update_form/spouse/'.$this->session->userdata('emp_id').'">'; ?> [Update] </a>
    <?php
    }
    else
    {
    ?>
        <?php echo '<a href="'.base_url().'index.php/forms/spouse">'; ?> [Add Spouse] </a>
    <?php
    }
    ?>
