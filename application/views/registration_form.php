    ...
    for($x=0;$x<count($page_view_content);$x++)
    {
        ...
        echo "<table class='form-group'>";
            ...
            echo form_open('register_faculty/add_new_record');
                ...
                echo "<tr><td>Birthday</td><td>".form_dropdown('month',$months, NULL, 'class="form-control input-sm"')."".form_dropdown('day',$days,  NULL, 'class="form-control input-sm"')."".form_dropdown('year',$year,  NULL, 'class="form-control input-sm"')."</td></tr>";
                ...
                echo "<tr><td colspan=2>".form_submit('mysubmit', 'Register', NULL, 'class="form-control input-sm"')."</td></tr>";
            echo form_close();
        echo "</table>";
    ?>
    <br/>
