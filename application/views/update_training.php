        ...
        for ($x=2014; $x>=1940; $x--)
        {
            ...
            echo "<table>";
                echo form_open('update/training');
                    ...
                    echo "<tr><td>Date</td><td>".form_dropdown('month',$months, $page_view_content['Month'])."".form_dropdown('day',$days, $page_view_content['Day'])."".form_dropdown('year',$year, $page_view_content['Year'])."</td></tr>";
