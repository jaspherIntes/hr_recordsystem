  ...
  <body>
   ...
   <div class="container-fluid">
    ...
    <ul class="nav nav-pills nav-stacked">
      ...
      <br/>
        <li>
            <a class="sub_menu" href="http://localhost/hr_recordsystem/index.php/view_admin">View Faculty</a>
        </li>
  </ul>
  <?php
    ...
    {?>
        <ul class="nav nav-pills nav-stacked">
            <li>
                <a href="http://localhost/hr_recordsystem/index.php/ranking_committee/view_rankMembers">View Committe</a>
            </li>
            <li>
                <a href="http://localhost/hr_recordsystem/index.php/ranking_committee/chairman_faculty_list">Rank Program [ranking module]</a>
            </li>
