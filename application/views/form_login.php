        ...
        <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
            <div class="panel panel-info" >
                    <div class="panel-heading">
                        ...
                        <div style="float:right; font-size: 80%; position: relative; top:-10px"><a href="http://localhost/hr_recordsystem/index.php/gfp" id="forgotPass">Forgot password?</a></div>
                    </div>     
                    ...
                    <div style="padding-top:30px" class="panel-body" >
                        ...
                        action="<?php echo base_url();?>index.php/login/form_login" method="post" name="login">
                            ...
                            <div style="margin-top:10px" class="form-group">
                                    ...
                                    <input id="btn-login" type="submit" name="login" value="Login" class="btn btn-primary"></a>
                                    </div>
                            </div>
